...
return [
    'ctrl' => [
        'title'	=> $ll . 'tx_trader_domain_model_tags',
        'label' => 'tag',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
        ...
        'searchFields' => 'tag,',
        'iconfile' => 'EXT:trader/Resources/Public/Icons/ext_tags.svg'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_trader_domain_model_tags.pid=###CURRENT_PID### AND tx_trader_domain_model_tags.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
	    ...
	    'tag' => [
	        'exclude' => 1,
	        'label' => $ll . 'tx_trader_domain_model_tags.tag',
	        'config' => [
			    'type' => 'input',
			    'size' => 30,
			    'eval' => 'trim'
